---
layout: default
title: '023. /azure-pipelines-frontend.yml (Line: 26, Col: 1): Unexpected valu…'
parent: Vercel para el frontend
nav_order: 23
permalink: /06-vercel/023/
---
...
**Sección:** Vercel para el frontend &middot; **Longitud:** 4,575 caracteres &middot; **Posición en la conversación:** 23 de 34

---

```
/azure-pipelines-frontend.yml (Line: 26, Col: 1): Unexpected value '  - group'
...
[← Prompt 022](/06-vercel/022/) &middot; [Volver a Vercel para el frontend](/06-vercel/) &middot; [Prompt 024 →](/06-vercel/024/)
{% endraw %}
