---
layout: default
title: '010. Este: 5. PAT en Grupo de VariablesEl secreto VERCEL-TOKEN está En…'
parent: Vercel para el frontend
nav_order: 10
permalink: /06-vercel/010/
---
...
**Sección:** Vercel para el frontend &middot; **Longitud:** 4,887 caracteres &middot; **Posición en la conversación:** 10 de 34
...
5. PAT en Grupo de VariablesEl secreto VERCEL-TOKEN está Enabled y seleccionado en el Grupo de Variables de Azure DevOps.Sí

III. Infraestructura Azure DevOps6. Extensión InstaladaLa extensión Vercel Deployment Task está instalada en tu organización de Azure DevOps.Por confirma
...
  VERCEL_PROJECT_ID: 'prj_YDYhdgLT12EU3Tfp7o0OlAiK66iN' # <--- Tu Project ID

  VERCEL_TEAM_ID: 'team_rFjZG0SVqdEif7MINfBqAoiJ'    # <--- Tu Team ID
...
[← Prompt 009](/06-vercel/009/) &middot; [Volver a Vercel para el frontend](/06-vercel/) &middot; [Prompt 011 →](/06-vercel/011/)
{% endraw %}
