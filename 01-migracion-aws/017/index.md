---
layout: default
title: '017. Para que te hagas una idea asi lo desplegaba: # azure-pipelines.y…'
parent: Migración a AWS
nav_order: 17
permalink: /01-migracion-aws/017/
---
...
**Sección:** Migración a AWS &middot; **Longitud:** 7,541 caracteres &middot; **Posición en la conversación:** 17 de 64

---

```
Para que te hagas una idea asi lo desplegaba:
...
[← Prompt 016](/01-migracion-aws/016/) &middot; [Volver a Migración a AWS](/01-migracion-aws/) &middot; [Prompt 018 →](/01-migracion-aws/018/)
{% endraw %}
