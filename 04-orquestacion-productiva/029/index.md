---
layout: default
title: '029. Siempre devuelve el agente completo: { ''nodes'': [ { ''parameters..…'
parent: Orquestación n8n productiva
nav_order: 29
permalink: /04-orquestacion-productiva/029/
---
...
**Sección:** Orquestación n8n productiva &middot; **Longitud:** 15,025 caracteres &middot; **Posición en la conversación:** 29 de 103

---

```
Siempre devuelve el agente completo:
...
Cuando se modifique la descricpion solo dame la descripcion o lo que debo cambiar para no generar todos lso nodos otra vez
```
...
[← Prompt 028](/04-orquestacion-productiva/028/) &middot; [Volver a Orquestación n8n productiva](/04-orquestacion-productiva/) &middot; [Prompt 030 →](/04-orquestacion-productiva/030/)
{% endraw %}
